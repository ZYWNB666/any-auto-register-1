...
CONFIG_KEYS = [
    ...
    "freemail_api_url", "freemail_admin_token", "freemail_username", "freemail_password", "freemail_domain_index",
    "moemail_api_url",
    "mail_provider",
    ...
    "sub2api_api_url", "sub2api_api_key", "sub2api_import_path", "sub2api_skip_default_group_bind",
